...
#### Exploring Results
The results of SPARQL Construct and Describe queries which are displayed in editor documents can be explored using the 
[Definitions Tree](/features/definitions-tree).

<img class="screenshot" src="/screenshots/notebook-output-turtle.png" alt="Screenshot of a Turtle cell"/>

<Aside type="note">
Unfortunately, the output of notebook cells cannot be processed in the same way at the time of this writing. However,
you can right-click the output cell in a notebook and select 'Open Cell Output in Text Editor' to achieve this.
</Aside>
