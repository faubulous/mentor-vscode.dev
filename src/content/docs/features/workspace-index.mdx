...
<img class="my-3" src="/workspace-index.svg" alt="Schematic of the Mentor workspace index process and features."/>
...
<img class="screenshot my-3" src="/screenshots/index-status.png" alt="Screenshot of the Indexing status bar in Visual Studio Code" width="700" />

## Indexing Settings

Clicking on the workspace index status bar item will open the Indexing page in the Mentor settings, which provides statistics about
the current index run and all relevant configuration options:

<img class="screenshot my-3" src="/screenshots/index-settings.png" alt="Screenshot of the Indexing settings page" width="700" />

Below the index statistics, the settings page offers the following commands:

| Command      | Description |
| ----------------- | ------------- |
| *Diagnose Workspace*  | Try to load every file in the workspace to detect syntax errors. Does not execute SHACL validation. |
| *Reindex Workspace* | Clear internal triple store and re-run a the indexing proccess, including the configurated SHACL validation. |
| *Show Index Log*     | Open a panel which contains a detailed output of the last indexing run. |

## Linting and Validation Results
All detected parsing, linting or validation results from the indexing run can be accessed via the standard Visual Studio Code Problems panel:

<img class="screenshot my-3" src="/screenshots/problems-panel.png" alt="Screenshot of the Visual Studio Code Problems Panel" width="700" />
